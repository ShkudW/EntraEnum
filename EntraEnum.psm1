function Invoke-EntraEnum {
    ...
    function Show-Usage {
        ...
        Write-Host ""
        Write-Host "Flags with -AccessToken and -domain flags:" -ForegroundColor Green
        Write-Host "------------------------------------------" -ForegroundColor Green
        Write-Host "  -users                           : List all users in the domain, Only with '-domain' and '-AccessToken' flags" -ForegroundColor Magenta
        Write-Host "  -groups                          : List all groups in the domain, Only with '-domain' and '-AccessToken' flags" -ForegroundColor Magenta
        Write-Host "  -applications                    : List all applications in the domain, Only with '-domain' and '-AccessToken' flags" -ForegroundColor Magenta
        Write-Host "  -servicePrincipals               : List all service principals in the domain, Only with '-domain' and '-AccessToken' flags" -ForegroundColor Magenta
        Write-Host "  -devices                         : List all devices in the domain, Only with '-domain' and '-AccessToken' flags" -ForegroundColor Magenta
        Write-Host "  -roles                           : List all roles in the domain, Only with '-domain' and '-AccessToken' flags" -ForegroundColor Magenta
        Write-Host "  -signins                         : List recent sign-ins for the domain, Only with '-domain' and '-AccessToken' flags" -ForegroundColor Magenta
        Write-Host "  -subscriptions                   : List all subscriptions in the domain, Only with '-domain' and '-AccessToken' flags" -ForegroundColor Magenta
        Write-Host "  -contacts                        : List all contacts in the domain, Only with '-domain' and '-AccessToken' flags" -ForegroundColor Magenta
        Write-Host ""
